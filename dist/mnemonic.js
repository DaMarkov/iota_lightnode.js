...
function decodeWords(wordString)
{
    ...
    if (words.length < 36)
    {
        console.error("Not enough words. There should be 36. Try again!");
        error = true;
    }
    var wordHash = {};
    ...
    {
        console.error("Wrong words, word-order, or parity word (last word). Try again!");
        error = true;
    }
    ...
    for (var i = 0; i < words.length; i++)
    {
        ...
        if (!word)
        {
            console.error("Unknown word entered: " + words[i] + "! Try again!");
            error = true;
        }
    ...
    var nr = bigInt.fromArray(array, window.dictionary.length);
    return toTryteString(nr);
}
...
function encodeSeed(seed)
{
    ...
    if (words.length < 35)
    {
        console.error("Word list too short. Try again!");
        return false;
    }
